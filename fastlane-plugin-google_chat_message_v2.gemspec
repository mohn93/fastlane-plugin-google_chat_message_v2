...
require 'fastlane/plugin/google_chat_message_v2/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-google_chat_message_v2'
  spec.version       = Fastlane::GoogleChatMessageV2::VERSION
